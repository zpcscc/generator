...
export interface CascadeProps extends Omit<SelectProps, 'onChange' | 'value'> {
  value: string[];
  cascadeData: string[][];
  styled?: string;
  level?: number;
  FormSelectOptions?: Omit<SelectProps, 'onChange' | 'optionsConfig'>;
  FormTextAreaOptions?: Omit<TextAreaProps, 'onChange'>;
